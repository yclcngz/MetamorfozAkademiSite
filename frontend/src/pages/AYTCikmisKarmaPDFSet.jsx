...
const SHOPIER_DIGITAL_URL = 'https://www.shopier.com/metamorfozakademi/45859242'; // PDF ürün linki
...
const STYLES = `
  ...
  .cpdf-price-badge-label {
    ...
    text-transform: uppercase; color: rgba(52,211,153,0.7); line-height: 1; margin-bottom: 2px;
  }
  ...
  .cpdf-cta-price-currency {
    font-size: 1rem; font-weight: 700; color: #34d399; line-height: 1;
  }
  .cpdf-cta-price-note {
...
const FEATURES = [
  '7 adet AYT matematik bölüm denemesi (her biri 40 soru)',
...
const DENEME_CONTENTS = [
  { num: '01', label: 'Deneme 1', img: '/ayt-deneme-01-cover.jpg' },
  { num: '02', label: 'Deneme 2', img: '/ayt-deneme-02-cover.jpg' },
  { num: '03', label: 'Deneme 3', img: '/ayt-deneme-03-cover.jpg' },
  { num: '04', label: 'Deneme 4', img: '/ayt-deneme-04-cover.jpg' },
  { num: '05', label: 'Deneme 5', img: '/ayt-deneme-05-cover.jpg' },
  { num: '06', label: 'Deneme 6', img: '/ayt-deneme-06-cover.jpg' },
  { num: '07', label: 'Deneme 7', img: '/ayt-deneme-07-cover.jpg' },
];

export default function AYTCikmisKarmaPDFSet() {
  const [showPayModal, setShowPayModal] = useState(false);

  const handleHavale = () => {
    setShowPayModal(false);
    const msg = encodeURIComponent('Merhaba! AYT Matematik Çıkmış Karma 7\'li Bölüm Denemesi PDF Seti için havale/EFT ile ödeme yapmak istiyorum. Hesap bilgilerini paylaşabilir misiniz?');
    ...
    <>
        ...
        <div className="pay-overlay" onClick={() => setShowPayModal(false)}>
          <div className="pay-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="pay-sub">
              AYT Matematik Çıkmış Karma 7'li Set için nasıl ödeme yapmak istersiniz?
            </div>
      ...
      <div className="cpdf-page">
        ...
        <div className="cpdf-inner">
          {/* ── Back ── */}
          <Link to="/ogrenci-pdf/ayt" className="cpdf-back">
          ...
          <div className="cpdf-banner">
            <div className="cpdf-banner-text">
              ...
              <div className="cpdf-banner-sub">
                7'li AYT Matematik Çıkmış Karma Bölüm Denemesi — gerçek ÖSYM formatı
              </div>
            </div>
          ...
          <div className="cpdf-body">
            ...
            >
              <img src="/ayt-deneme-01-cover.jpg" alt="AYT Matematik Çıkmış Karma 7'li Bölüm Denemesi PDF Seti" />
            </div>

            {/* Info */}
            <div className="cpdf-info">
              <div className="cpdf-info-card">
                <div className="cpdf-info-title">AYT Matematik Çıkmış Karma 7'li Set</div>
